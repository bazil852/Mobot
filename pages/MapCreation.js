...
export default function MapCreation({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Map Creation</Text>
      <Text style={styles.subtitle}>Map -101 <Image onPress={() => setModalVisible(true)} source={require('../assets/edit.png')}></Image> </Text>
  ...
  radius={55} 
  onMove={(data) => {
    console.log("Joystick dx:", data.position.x,"Joystick dx: ",data.position.y);
