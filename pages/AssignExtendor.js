...
export default function AssignExtendor({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Assign Extendor</Text>
        <Text style={styles.subtitle}>A device that enhances the reach or coverage of a network connection.</Text>
      </View>

      <ScrollView style={styles.deviceList}>
        <Text style={styles.deviceCategory}>Connected Extender</Text>
        <Text style={styles.deviceItem}>Extender -1</Text>
        <Text style={styles.deviceItemSub}>Connected</Text>

        <Text style={styles.deviceCategory}>Available Devices</Text>
        <Text style={styles.deviceItemNull}>Extender -2</Text>
        <Text style={styles.deviceItemNull}>Extender -3</Text>
      </ScrollView>
      ...
      <View style={styles.footer}>
        ...
        onPress={() => navigation.navigate('DropExtender')}
        >
